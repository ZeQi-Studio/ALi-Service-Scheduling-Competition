...
class expert:
    ...
    def __init_expert__(self):
        with open(self.__path__, encoding='utf-8') as f:
            ...
            # print((expert_list[1]))
            self.expert_processing_task_num = [3 for i in range(1,len(expert_list))]
        return expert_list
    ...
    def __get_expert_task_dict__(self):
        ...
        for i in range(1, len(expert_list[0])):
            temp_dict = {}
            for j in range(1, len(expert_list)):
